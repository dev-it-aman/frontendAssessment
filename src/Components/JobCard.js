...
const JobCard = ({openingData, deleteHandler, editHandler}) => {
    ...
    return (
        <div className='w-[45%] px-6 py-4 bg-white rounded-[10px] border border-black-300 flex justify-between gap-2.5'>
            ...
            <div className=" items-start w-32 h-14 gap-2 flex justify-end ">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 hover:text-blue-700 transform scale-100 hover:scale-125 transition-transform duration-300 cursor-pointer" onClick={editButtonClick}>
